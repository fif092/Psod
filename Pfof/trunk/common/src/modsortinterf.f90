...
Contains
  ...
  Subroutine heapsort_refI_2x3R_1xR_2xI(n,tref,tx,tv,tp,tid,trid)
    ...
    Call construction_refI_2x3R_1xR_2xI(size,n,tref,tx,tv,tp,tid,trid)

    Do i = n, 2, -1
       Call echanger_refI_2x3R_1xR_2xI(1,i,tref,tx,tv,tp,tid,trid)
       size = size - 1
       Call entasser_refI_2x3R_1xR_2xI(size,1,tref,tx,tv,tp,tid,trid)
    End Do
  ...
  Subroutine construction_refI_2x3R_1xR_2xI(size,n,tref,tx,tv,tp,tid,trid)
    ...
    size = n
    Do i = n/2, 1, -1
       Call entasser_refI_2x3R_1xR_2xI(size,i,tref,tx,tv,tp,tid,trid)
    End Do
  ...
  End Subroutine construction_refI_2x3R_1xR_2xI


  !=======================================================================


  Recursive Subroutine entasser_refI_2x3R_1xR_2xI(size,i,tref,tx,tv,tp,tid,trid)
    ...
    If( max /= i ) Then
       Call echanger_refI_2x3R_1xR_2xI(i,max,tref,tx,tv,tp,tid,trid)
       Call entasser_refI_2x3R_1xR_2xI(size,max,tref,tx,tv,tp,tid,trid)
    End If
  ...
  End Subroutine entasser_refI_2x3R_1xR_2xI


  !=======================================================================


  Subroutine echanger_refI_2x3R_1xR_2xI(i,j,tref,tx,tv,tp,tid,trid)
  ...
  End Subroutine echanger_refI_2x3R_1xR_2xI
  ...
  Subroutine heapsort_refI_2x3R_2xI(n,tref,tx,tv,tid,trid)
    ...
    Call construction_refI_2x3R_2xI(size,n,tref,tx,tv,tid,trid)

    Do i = n, 2, -1
       Call echanger_refI_2x3R_2xI(1,i,tref,tx,tv,tid,trid)
       size = size - 1
       Call entasser_refI_2x3R_2xI(size,1,tref,tx,tv,tid,trid)
    End Do
  ...
  Subroutine construction_refI_2x3R_2xI(size,n,tref,tx,tv,tid,trid)
    ...
    size = n
    Do i = n/2, 1, -1
       Call entasser_refI_2x3R_2xI(size,i,tref,tx,tv,tid,trid)
    End Do
  ...
  End Subroutine construction_refI_2x3R_2xI


  !=======================================================================

  Recursive Subroutine entasser_refI_2x3R_2xI(size,i,tref,tx,tv,tid,trid)
    ...
    If( max /= i ) Then
       Call echanger_refI_2x3R_2xI(i,max,tref,tx,tv,tid,trid)
       Call entasser_refI_2x3R_2xI(size,max,tref,tx,tv,tid,trid)
    End If
  ...
  End Subroutine entasser_refI_2x3R_2xI


  !=======================================================================

  Subroutine echanger_refI_2x3R_2xI(i,j,tref,tx,tv,tid,trid)
  ...
  End Subroutine echanger_refI_2x3R_2xI
  ...
  Subroutine heapsort_refI_3x3R_1xR_2xI(n,tref,tx,tv,tf,tp,tid,trid)
    ...
    Call construction_refI_3x3R_1xR_2xI(size,n,tref,tx,tv,tf,tp,tid,trid)

    Do i = n, 2, -1
       Call echanger_refI_3x3R_1xR_2xI(1,i,tref,tx,tv,tf,tp,tid,trid)
       size = size - 1
       Call entasser_refI_3x3R_1xR_2xI(size,1,tref,tx,tv,tf,tp,tid,trid)
    End Do
  ...
  Subroutine construction_refI_3x3R_1xR_2xI(size,n,tref,tx,tv,tf,tp,tid,trid)
    ...
    size = n
    Do i = n/2, 1, -1
       Call entasser_refI_3x3R_1xR_2xI(size,i,tref,tx,tv,tf,tp,tid,trid)
    End Do
  ...
  End Subroutine construction_refI_3x3R_1xR_2xI


  !=======================================================================


  Recursive Subroutine entasser_refI_3x3R_1xR_2xI(size,i,tref,tx,tv,tf,tp,tid,trid)
    ...
    If( max /= i ) Then
       Call echanger_refI_3x3R_1xR_2xI(i,max,tref,tx,tv,tf,tp,tid,trid)
       Call entasser_refI_3x3R_1xR_2xI(size,max,tref,tx,tv,tf,tp,tid,trid)
    End If
  ...
  End Subroutine entasser_refI_3x3R_1xR_2xI


  !=======================================================================


  Subroutine echanger_refI_3x3R_1xR_2xI(i,j,tref,tx,tv,tf,tp,tid,trid)
  ...
  End Subroutine echanger_refI_3x3R_1xR_2xI
  ...
  Subroutine heapsort_refI_3x3R_2xI(n,tref,tx,tv,tf,tid,trid)
    ...
    Call construction_refI_3x3R_2xI(size,n,tref,tx,tv,tf,tid,trid)

    Do i = n, 2, -1
       Call echanger_refI_3x3R_2xI(1,i,tref,tx,tv,tf,tid,trid)
       size = size - 1
       Call entasser_refI_3x3R_2xI(size,1,tref,tx,tv,tf,tid,trid)
    End Do
  ...
  Subroutine construction_refI_3x3R_2xI(size,n,tref,tx,tv,tf,tid,trid)
    ...
    size = n
    Do i = n/2, 1, -1
       Call entasser_refI_3x3R_2xI(size,i,tref,tx,tv,tf,tid,trid)
    End Do
  ...
  End Subroutine construction_refI_3x3R_2xI


  !=======================================================================


  Recursive Subroutine entasser_refI_3x3R_2xI(size,i,tref,tx,tv,tf,tid,trid)
    ...
    If( max /= i ) Then
       Call echanger_refI_3x3R_2xI(i,max,tref,tx,tv,tf,tid,trid)
       Call entasser_refI_3x3R_2xI(size,max,tref,tx,tv,tf,tid,trid)
    End If
  ...
  End Subroutine entasser_refI_3x3R_2xI


  !=======================================================================


  Subroutine echanger_refI_3x3R_2xI(i,j,tref,tx,tv,tf,tid,trid)
  ...
  End Subroutine echanger_refI_3x3R_2xI
