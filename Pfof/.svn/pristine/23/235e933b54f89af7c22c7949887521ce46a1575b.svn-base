...
!!$       If (x(3,ipart) == 1.0) x(3,ipart) = 0.00000
    ...
    Call gatherhaloes(Mpi_Comm_World)
    ...
    !!Call trirapide(1,myfinalnpart,stf,idf,posf,velf)
    !!Call tritas(stf,idf,posf,velf,myfinalnpart)
    ...
    Call h5writehalopart(Mpi_Comm_World, haloNB, halopartNB, haloMass, haloID, halopartPos, halopartVel, halopartID)
    ...
    Call mpih5writehalomass(Mpi_Comm_World,haloNB_all, haloNB, nh, haloMass, halocomPos, halocomVel, &
