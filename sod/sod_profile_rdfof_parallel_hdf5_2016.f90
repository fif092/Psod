...
contains
  subroutine read_params
    ...
    use modparameters
      ...
      param%do_read_potential=.false.
      param%do_read_gravitational_field=.false.
      ...
      param%grpsize=0
      param%gatherread_factor=2
      param%snapshot=nsnap         
      param%gatherwrite_factor=2
      ...
      if(param%gatherread_factor.ne.2) then
         print*,'WARNING GATHER WRITE IS NOT THE EXPECTED ONE IN MODEXTRACT=>TO BE IMPROVED',param%gatherread_factor
         stop
      endif
