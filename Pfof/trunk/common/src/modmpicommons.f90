Module modmpicommons
  ...
  Integer(kind=4) :: Mpi_Type_infocone_part
  Integer(kind=4) :: Mpi_Type_infocone_grav
  Integer(kind=4) :: Mpi_Type_parameter_pfof_snap
  Integer(kind=4) :: Mpi_Type_parameter_pfof_cone
  Integer(kind=4) :: Mpi_Type_parameter_cone_part
  Integer(kind=4) :: Mpi_Type_parameter_cone_grav
...
Contains
  ...
  Subroutine create_mpi_type_info 
    ...
    Type(Type_infocone_part) :: fooconepart
    Type(Type_infocone_grav) :: fooconegrav
    ...
    Call Mpi_Type_Create_Struct(39, blocklen, disp, type, Mpi_Type_infocone_part, mpierr) 
    Call Mpi_Type_Commit(Mpi_Type_infocone_part, mpierr) 
    ...
    Call Mpi_Type_Create_Struct(37, blocklen, disp, type, Mpi_Type_infocone_grav, mpierr) 
    Call Mpi_Type_Commit(Mpi_Type_infocone_grav, mpierr) 
