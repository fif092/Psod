...
! Loop on the utile zones (cube of number nzone) that will be analyzed 
  do nzone=firstp,lastp
     ...
     if(IOGROUPSIZE>0) then
        ...
        type = 'cuboid'
        filename='/data/yrasera/prepa4096/boxlen80_n128_lcdmw7_64tasks/post/fof/output_00004/fof_boxlen80_n128_lcdmw7_64tasks_sortedcube'
        center(1)=xc
        center(2)=yc
        center(3)=zc
